 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://ws/", wsdlLocation = "http://localhost:4789/ws/login?WSDL")
    ...
    extends Service
{
    ...
    private final static QName LOGINSERVICE_QNAME = new QName("http://ws/", "LoginService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:4789/ws/login?WSDL");
    ...
    public ILogin getLoginPort() {
        return super.getPort(new QName("http://ws/", "LoginPort"), ILogin.class);
    }
    ...
    public ILogin getLoginPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws/", "LoginPort"), ILogin.class, features);
    }
