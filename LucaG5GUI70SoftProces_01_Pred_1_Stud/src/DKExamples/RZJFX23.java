...
import Structure.*;
import Structures.SkakacevSkok;
...
public class RZJFX23 {
    ...
    public static void main(String[] args) throws IOException, FileNotFoundException, ClassNotFoundException, InterruptedException {
        ...
        lengine.connectSTC(new SkakacevSkok(),"FXMLDocument1.lctm", "FXMLDocument.fxml", pfr.domainClassesFolderPath);
