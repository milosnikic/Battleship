 CREATE DATABASE /*!32312 IF NOT EXISTS*/`DKExample73G` /*!40100 DEFAULT CHARACTER SET utf8 */;
...
BEGIN
 ...
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'SifraPartnera'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `SifraPartnera` int (11) NOT NULL   ; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'NazivPartnera'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `NazivPartnera` varchar (30)    DEFAULT NULL; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'Adresa'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `Adresa` varchar (50)    DEFAULT NULL; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'PIB'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `PIB` varchar (15)    DEFAULT NULL; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'DatumOsnivanja'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `DatumOsnivanja` date       DEFAULT NULL; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'UkupniIznos'); 
 IF _count = 0 THEN  ALTER TABLE PoslovniPartner ADD COLUMN  `UkupniIznos` double       DEFAULT 0; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'PoslovniPartner' AND COLUMN_NAME = 'SifraGrada'); 
...
BEGIN
 DECLARE _count INT;
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Grad' AND COLUMN_NAME = 'SifraGrada'); 
 IF _count = 0 THEN  ALTER TABLE Grad ADD COLUMN  `SifraGrada` int (11) NOT NULL   ; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Grad' AND COLUMN_NAME = 'NazivGrada'); 
...
BEGIN
 DECLARE _count INT;
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Proizvod' AND COLUMN_NAME = 'SifraProizvoda'); 
 IF _count = 0 THEN  ALTER TABLE Proizvod ADD COLUMN  `SifraProizvoda` int (11) NOT NULL   ; END IF;   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS 
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Proizvod' AND COLUMN_NAME = 'NazivProizvoda'); 
...
BEGIN
 DECLARE _count INT;
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS  
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Counter' AND COLUMN_NAME = 'TableName'); 
 IF _count = 0 THEN  ALTER TABLE Counter ADD COLUMN  `TableName` varchar(100)  ; END IF; 
   
 SET _count = (  SELECT COUNT(*) FROM INFORMATION_SCHEMA.COLUMNS  
 WHERE   TABLE_SCHEMA = 'DKExample73G' AND TABLE_NAME = 'Counter' AND COLUMN_NAME = 'Counter'); 
